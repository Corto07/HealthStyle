...
const MainHeader = () => {
  ...
  return (
    <header className="bg-emerald-500 sm:flex sm:justify-between sm:px-4 sm:py-3 sm:items-center">
      <div className="flex items-center justify-between px-4 py-3 sm:p-0" >
        <div>
          <img className="h-10 pl-8" src="src\asset\healthstyleLogo.svg" alt="Healthstyle"></img>
        </div>
        <div className="sm:hidden">
          <button type="button" onClick={toggleMenu}>
            <img className="h-6" src="src\asset\burgerMenu.svg" alt="" />
          </button>
        </div>
      </div>
  ...
  <img class="h-6 transition duration-300 transform hover:scale-110" src="src\asset\cart-shopping-solid.svg" alt="" />
</button>
